...
import com.example.sig.lianjiang.parse.UserProfileManager;
import com.example.sig.lianjiang.receiver.CallReceiver;
import com.example.sig.lianjiang.receiver.HeadsetReceiver;
...
import com.example.sig.lianjiang.utils.PreferenceManager;
...
public class StarryHelper {
    ...
    protected static final String TAG = "StarryHelper";
    ...
    private static StarryHelper instance = null;

    private StarryModel demoModel = null;
    ...
    private StarryHelper() {
        executor = Executors.newCachedThreadPool();
    }

    public synchronized static StarryHelper getInstance() {
        if (instance == null) {
            instance = new StarryHelper();
        }
        return instance;
    }
    ...
    public void init(Context context) {
        demoModel = new StarryModel(context);
...
//    }
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            Map<String, EaseUser> localUsers = StarryHelper.getInstance().getContactList();
...
//        return false;
    ...
    public StarryModel getModel(){
        return (StarryModel) demoModel;
    }
