...
public class StarryDBManager {
    static private StarryDBManager dbMgr = new StarryDBManager();
    private DbOpenHelper dbHelper;

    private StarryDBManager(){
        dbHelper = DbOpenHelper.getInstance(StarryApplication.getInstance().getApplicationContext());
    }

    public static synchronized StarryDBManager getInstance(){
        if(dbMgr == null){
            dbMgr = new StarryDBManager();
        }
        return dbMgr;
    }
