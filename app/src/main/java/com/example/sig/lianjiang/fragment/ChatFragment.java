...
import com.example.sig.lianjiang.activity.ChatRoomDetailsActivity;
import com.example.sig.lianjiang.activity.ContextMenuActivity;
import com.example.sig.lianjiang.activity.ForwardMessageActivity;
import com.example.sig.lianjiang.activity.GroupDetailsActivity;
import com.example.sig.lianjiang.activity.ImageGridActivity;
import com.example.sig.lianjiang.activity.MainActivity;
import com.example.sig.lianjiang.activity.PickAtUserActivity;
...
import com.example.sig.lianjiang.StarryModel;
import com.example.sig.lianjiang.R;
//import com.example.sig.lianjiang.conference.ConferenceActivity;
import com.example.sig.lianjiang.domain.EmojiconExampleGroupData;
import com.example.sig.lianjiang.domain.RobotUser;
import com.example.sig.lianjiang.widget.ChatRowConferenceInvitePresenter;
import com.example.sig.lianjiang.widget.EaseChatRecallPresenter;
import com.example.sig.lianjiang.widget.EaseChatVoiceCallPresenter;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return super.onCreateView(inflater, container, savedInstanceState,
                StarryHelper.getInstance().getModel().isMsgRoaming() && (chatType != EaseConstant.CHATTYPE_CHATROOM));
    }

    @Override
    protected boolean turnOnTyping() {
        return StarryHelper.getInstance().getModel().isShowMsgTyping();
    }
    ...
    protected void setUpView() {
        ...
        if (chatType == Constant.CHATTYPE_SINGLE) {
            Map<String,RobotUser> robotMap = StarryHelper.getInstance().getRobotList();
...
//                    return new ChatRowConferenceInvitePresenter();
    ...
    public void getNamePost() {
        final List<OkHttpUtils.Param> list = new ArrayList<OkHttpUtils.Param>();
        //可以传多个参数，这里只写传一个参数，需要传多个参数时list.add();
        OkHttpUtils.Param idParam = new OkHttpUtils.Param("id", toChatUsername);
        list.add(idParam);
