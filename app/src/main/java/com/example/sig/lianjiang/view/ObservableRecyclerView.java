...
/**
 * Created by sig on 2018/7/28.
 */

public class ObservableRecyclerView extends RecyclerView implements AbsListView.OnScrollListener{
    ...
    private ObservableListView.OnMeiTuanRefreshListener mOnRefreshListener;
    private int state;
     ...
     */
    public void setOnMeiTuanRefreshListener(ObservableRecyclerView.OnMeiTuanRefreshListener onRefreshListener){
...
//        addHeaderView(headerView);
    ...
    public void setScrollViewListener(ObservableRecyclerView.ScrollViewListener scrollViewListener) {
        this.scrollViewListener = scrollViewListener;
    }

    private ObservableRecyclerView.ScrollViewListener scrollViewListener = null;
    ...
    public void onScroll(AbsListView absListView, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        if (null != firstView) {
            ObservableRecyclerView.ItemRecod itemRecord = (ObservableRecyclerView.ItemRecod) recordSp.get(firstVisibleItem);
            if (null == itemRecord) {
                itemRecord = new ObservableRecyclerView.ItemRecod();
            }
    ...
    private int getScrollY1() {
        ...
        for (int i = 0; i < mCurrentfirstVisibleItem; i++) {
            ObservableRecyclerView.ItemRecod itemRecod = (ObservableRecyclerView.ItemRecod) recordSp.get(i);
            height += itemRecod.height;
        }
        ObservableRecyclerView.ItemRecod itemRecod = (ObservableRecyclerView.ItemRecod) recordSp.get(mCurrentfirstVisibleItem);
        if (null == itemRecod) {
            itemRecod = new ObservableRecyclerView.ItemRecod();
        }
