...
import com.example.sig.lianjiang.adapter.CardAdapter;
        ...
        if (!isCanAlpha) {
            ...
            for(int i=0;i<mAdapter.getCount();i++){
                ...
                if (cardView != null) {
                    ...
                    cardView.findViewById(R.id.tip).setAlpha(1f);
                }
            }
            ...
            for(int i=0;i<mAdapter.getCount();i++){
                ...
                if(i==mViewPager.getCurrentItem()){
                    ...
                    if (cardView != null) {
                        ...
                        cardView.findViewById(R.id.tip).setAlpha(0f);
                    }
                }
            }
        }
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (currentCard != null) {
            ...
            if(mAlphaEnabled){
                ...
                currentCard.findViewById(R.id.tip).setAlpha(1-realOffset);
            }
        ...
        if (nextCard != null) {
            ...
            if(mAlphaEnabled){
                ...
                nextCard.findViewById(R.id.tip).setAlpha(realOffset);
            }
